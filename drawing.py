...
while not gameExit:
	...
	pygame.draw.rect(gameDisplay, blue, [100,100, 50, 50])

	gameDisplay.fill(blue, rect=[200,200, 20,20])


	gameDisplay.fill(blue, rect=[50,50, 20,20])
	pygame.draw.circle(gameDisplay, red, (100,100), 20, 0)
	pygame.draw.circle(gameDisplay, blue, (300,100), 75, 5)
	pygame.draw.circle(gameDisplay, green, (500,100), 20, 10)
